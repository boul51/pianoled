...
pl_thickness_y_top = 10;   // horizontal thickness on y axis
...
cable_width = 13; // width of the guide
cable_height = 2; // height of the guide
cable_height_tot = 6; // height of the guide
